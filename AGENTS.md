...
This file is the quick-reference operating contract for async-trait-kotlin. The longer
...
async-trait-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`async-trait`](https://crates.io/crates/async-trait). Upstream Rust is the behavioral oracle while the
