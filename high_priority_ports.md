...
|------|--------|--------|------------|------|-----------|-------------------|-------|---------------|-----------|------------|----------|
| 1 | `async-trait.expand` | `asynctrait.Expand` | 0.45 | 1 | 10/13 matched (target 16) | `to_tokens`, `visit_type_path_mut`, `visit_type_mut` | 2/3 matched (target 4) | `AssociatedTypeImplTraits` | 4 | 16 | 1041605.5 |
| 2 | `async-trait.args` | `asynctrait.Args` | 0.42 | 1 | 2/3 matched (target 4) | `parse` | 1/1 matched (target 2) | _none_ | 1 | 4 | 1010405.8 |
...
| 8 | `async-trait.lib` | `asynctrait.AsyncTrait [STUB]` | 0.00 | 0 | 1/1 matched (target 2) | _none_ | 0/0 matched | _none_ | 0 | 1 | 110.0 |
...
- **async-trait.args** → `asynctrait.Args`
