...
kotlin {
    ...
    val xcf = XCFramework("AsyncTrait")
    ...
    swiftExport {
        moduleName = "AsyncTrait"
        flattenPackage = "io.github.kotlinmania.asynctrait"
    }

    android {
        namespace = "io.github.kotlinmania.asynctrait"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "async-trait-kotlin", version.toString())

    pom {
        name.set("async-trait-kotlin")
        description.set("Kotlin Multiplatform port of dtolnay/async-tra - Type erasure for async trait methods")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/async-trait-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/async-trait-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/async-trait-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/async-trait-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve(
                "io/github/kotlinmania/asynctrait/codeql/_CodeqlEmptySource.kt",
            )
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.asynctrait.codeql
...
tasks.register("test") {
    group = "verification"
    description =
        "Runs the host-portable test suite. The default build task owns the full target surface."
...
val fullTargetBuildTaskNames = setOf(
    ...
    "assembleAsyncTraitXCFramework",
    "assembleAsyncTraitDebugXCFramework",
    "assembleAsyncTraitReleaseXCFramework",
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleAsyncTraitDebugXCFramework",
    "assembleAsyncTraitReleaseXCFramework",
    "assembleDebugIosFatFrameworkForAsyncTraitXCFramework",
    "assembleReleaseIosFatFrameworkForAsyncTraitXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForAsyncTraitXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForAsyncTraitXCFramework",
    "assembleDebugMacosFatFrameworkForAsyncTraitXCFramework",
    "assembleReleaseMacosFatFrameworkForAsyncTraitXCFramework",
    "assembleDebugTvosFatFrameworkForAsyncTraitXCFramework",
    "assembleReleaseTvosFatFrameworkForAsyncTraitXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForAsyncTraitXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForAsyncTraitXCFramework",
    "assembleDebugWatchosFatFrameworkForAsyncTraitXCFramework",
    "assembleReleaseWatchosFatFrameworkForAsyncTraitXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForAsyncTraitXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForAsyncTraitXCFramework",
    "exportCommonSourceSetsMetadataLocationsForMetadataApiElements",
    "exportRootPublicationCoordinatesForMetadataApiElements",
    "exportCrossCompilationMetadataForAndroidNativeArm32ApiElements",
    "exportCrossCompilationMetadataForAndroidNativeArm64ApiElements",
